...
export declare function getBlocks(): Block[];
export declare function getCharacters(): Character[];
/**
...
*/
export declare function evaluateNum(num: any): number;
/**
...
*/
export declare function parseBlocks(Blocks_txt: string): Block[];
/**
...
*/
export declare function parseUnicodeData(UnicodeData_txt: string): Character[];
